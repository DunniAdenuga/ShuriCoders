...
let j, cart, expected,
 ...
 LINKS = {
	base: 'https://shuricoders.firebaseio.com/'
 },
 fireConf = {
    apiKey: "AIzaSyAP0lwzdVfUpuS1FN5on8Oe7h-EIu9kTwc",
     authDomain: "shuricoders.firebaseapp.com",
     databaseURL: "https://shuricoders.firebaseio.com",
     projectId: "shuricoders",
 	storageBucket: " 	shuricoders.appspot.com",
     messagingSenderId: "279265960203"
};
	...
	function(request, sender, sendResponse) {
      ...
      leadsRef.on('value', function(snapshot) {
        snapshot.forEach(function(childSnapshot) {
          ...
          dataFromFireBase.push(childSnapshot.val());
			...
			firebase.database().goOnline();
      let cartContents = request.contents
			let id =  UUID(),
          ...
          //alert(JSON.stringify(dataFromFireBase, null, 4));
